...
public class ListaMesero extends javax.swing.JFrame {

    public static String user_update = "";

    /**
     * Creates new form frm_SearchWaiter
     */
    public ListaMesero() {
        initComponents();
        ...
        tablaMeseros.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseClicked(MouseEvent e) {
                int fila_point = tablaMeseros.rowAtPoint(e.getPoint());
                int columna_point = 4;
                if (fila_point > -1) {
                    DefaultTableModel modelo;
                    BD_REPORTES fun = new BD_REPORTES();
                    modelo = fun.mostrarMeseros("");
                    user_update = (String) modelo.getValueAt(fila_point, columna_point);
                    EditarMesero me = new EditarMesero();
                    me.setVisible(true);
                }
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel_Wallpaper, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 800, 333));
    ...
    public void mostrar(String buscar) {
        try {
            DefaultTableModel modelo;
            BD_REPORTES fun = new BD_REPORTES();
            modelo = fun.mostrarMeseros(buscar);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListaMesero.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListaMesero().setVisible(true);
            }
        });
    }
