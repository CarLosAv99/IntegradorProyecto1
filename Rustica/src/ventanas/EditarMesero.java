 ...
 * @author Frank
 */
public class EditarMesero extends javax.swing.JFrame {
String user_update = "";
    int ID;
    /**
    ...
    public EditarMesero() {
        initComponents();
        user_update = ListaMesero.user_update;
    ...
    private void initComponents() {
        ...
        getContentPane().add(txt_mail, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 150, 190, -1));
        ...
        getContentPane().add(txt_telefono, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 100, 190, -1));
        ...
        getContentPane().add(txt_nombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 60, 190, -1));

        btn_Actualizar.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        btn_Actualizar.setText("Actualizar Mesero");
        ...
        getContentPane().add(btn_Actualizar, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 260, 170, 70));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditarMesero.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditarMesero().setVisible(true);
            }
        });
    }
